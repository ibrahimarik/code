    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> <?=strtoupper($this->uri->segment(1))?>
                    <span>>
                        <?=mb_convert_case(mb_strtolower($this->uri->segment(2)), MB_CASE_TITLE, "UTF-8")?>
							</span></h1>
            </div>
