...
<aside id="left-panel">
    ...
    <div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it -->
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="/assets/backend/img/avatars/sunny.png" alt="<?=$this->session->userdata('ad')?> <?=$this->session->userdata('soyad')?>" class="online" />
						<span>
                            <?=$this->session->userdata('ad')?>
                            <?=$this->session->userdata('soyad')?>
						</span>
    ...
    <nav>
        ...
        <ul>
            <li class="">
                <a href="#" title="Ana Menü"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">ANA MENÜ</span></a>
                <ul>
                    <li class="<?=($this->uri->segment(2)==='portal')?'active':''?>">
                        <a href="<?=base_url("yonetim/portal")?>" title="Ana Sayfa"><span class="menu-item-parent">Ana Sayfa</span></a>
                    </li>
                </ul>
            </li>
            <li class="top-menu-invisible">
                <a href="#"><i class="fa fa-lg fa-fw fa-cube txt-color-blue"></i> <span class="menu-item-parent">PROJELER</span></a>
                <ul>
                    <li>
                        <a href="<?=base_url("yonetim/harita")?>" title="Dashboard"><span class="menu-item-parent">Harita</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="display-users">
                            ...
                            <a href="#" class="usr"
                               ...
                               data-content="
											<div class='usr-card'>
												<img src='/assets/backend/img/avatars/1.png' alt='Jessica Dolof'>
												<div class='usr-card-content'>
													<h3>Jessica Dolof</h3>
                            ...
                            <a href="#" class="usr"
                               ...
                               data-content="
											<div class='usr-card'>
												<img src='/assets/backend/img/avatars/3.png' alt='Zekarburg Almandalie'>
												<div class='usr-card-content'>
                            ...
                            <a href="#" class="usr"
                               ...
                               data-content="
											<div class='usr-card'>
												<img src='/assets/backend/img/avatars/4.png' alt='Barley Krazurkth'>
												<div class='usr-card-content'>
                            ...
                            <a href="#" class="usr offline"
                               ...
                               data-content="
											<div class='usr-card'>
												<img src='/assets/backend/img/avatars/female.png' alt='Farhana Amrin'>
												<div class='usr-card-content'>
													<h3>Farhana Amrin</h3>
                            ...
                            <a href="#" class="usr offline"
                               ...
                               data-content="
											<div class='usr-card'>
												<img src='/assets/backend/img/avatars/male.png' alt='Lezley Jacob'>
												<div class='usr-card-content'>
													<h3>Lezley Jacob</h3>
													<p>Sales Director</p>
												</div>
